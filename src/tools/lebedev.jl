...
if ~haskey(rules,N) error("Error in quadLebedev.jl: Lebedev quadrature is not available at order ",N,".") end

function LebedevByPoints(n::Integer)
...
#=
    gen_oh!(code::Integer, a::Real, b::Real, v::Real, n::Integer,
            μ::AbstractArray, η::AbstractArray, ξ::AbstractArray, w::AbstractArray)
...
The input arrays `μ`, `η`, `ξ` and `w` are modified in-place starting at index `n+1`.
...
function gen_oh!(code::Integer, a::Real, b::Real, v::Real, n::Integer,
    ...
    if code == 1
        a = 1.0
        μ[n + 1] =   a; η[n + 1] = 0.0; ξ[n + 1] = 0.0; w[n + 1] = v;
        μ[n + 2] =  -a; η[n + 2] = 0.0; ξ[n + 2] = 0.0; w[n + 2] = v;
        μ[n + 3] = 0.0; η[n + 3] =   a; ξ[n + 3] = 0.0; w[n + 3] = v;
        μ[n + 4] = 0.0; η[n + 4] =  -a; ξ[n + 4] = 0.0; w[n + 4] = v;
        μ[n + 5] = 0.0; η[n + 5] = 0.0; ξ[n + 5] =   a; w[n + 5] = v;
        μ[n + 6] = 0.0; η[n + 6] = 0.0; ξ[n + 6] =  -a; w[n + 6] = v;
        n = 6
    elseif code == 2
        a = 1.0 / sqrt(2.0)
        μ[n + 1] = 0.0; η[n + 1] =   a; ξ[n + 1] =   a; w[n + 1] = v;
        μ[n + 2] = 0.0; η[n + 2] =   a; ξ[n + 2] =  -a; w[n + 2] = v;
        μ[n + 3] = 0.0; η[n + 3] =  -a; ξ[n + 3] =   a; w[n + 3] = v;
        μ[n + 4] = 0.0; η[n + 4] =  -a; ξ[n + 4] =  -a; w[n + 4] = v;
        μ[n + 5] =   a; η[n + 5] = 0.0; ξ[n + 5] =   a; w[n + 5] = v;
        μ[n + 6] =   a; η[n + 6] = 0.0; ξ[n + 6] =  -a; w[n + 6] = v;
        μ[n + 7] =  -a; η[n + 7] = 0.0; ξ[n + 7] =   a; w[n + 7] = v;
        μ[n + 8] =  -a; η[n + 8] = 0.0; ξ[n + 8] =  -a; w[n + 8] = v;
        μ[n + 9] =   a; η[n + 9] =   a; ξ[n + 9] = 0.0; w[n + 9] = v;
        μ[n + 10] =   a; η[n + 10] =  -a; ξ[n + 10] = 0.0; w[n + 10] = v;
        μ[n + 11] =  -a; η[n + 11] =   a; ξ[n + 11] = 0.0; w[n + 11] = v;
        μ[n + 12] =  -a; η[n + 12] =  -a; ξ[n + 12] = 0.0; w[n + 12] = v;
        n = 12
    elseif code == 3
        a = 1.0 / sqrt(3.0)
        μ[n + 1] =   a; η[n + 1] =   a; ξ[n + 1] =   a; w[n + 1] = v;
        μ[n + 2] =   a; η[n + 2] =   a; ξ[n + 2] =  -a; w[n + 2] = v;
        μ[n + 3] =   a; η[n + 3] =  -a; ξ[n + 3] =   a; w[n + 3] = v;
        μ[n + 4] =   a; η[n + 4] =  -a; ξ[n + 4] =  -a; w[n + 4] = v;
        μ[n + 5] =  -a; η[n + 5] =   a; ξ[n + 5] =   a; w[n + 5] = v;
        μ[n + 6] =  -a; η[n + 6] =   a; ξ[n + 6] =  -a; w[n + 6] = v;
        μ[n + 7] =  -a; η[n + 7] =  -a; ξ[n + 7] =   a; w[n + 7] = v;
        μ[n + 8] =  -a; η[n + 8] =  -a; ξ[n + 8] =  -a; w[n + 8] = v;
        n = 8
    elseif code == 4
        b = sqrt(1.0 - 2.0 * a^2)
        μ[n + 1] =   a; η[n + 1] =   a; ξ[n + 1] =   b; w[n + 1] = v;
        μ[n + 2] =   a; η[n + 2] =   a; ξ[n + 2] =  -b; w[n + 2] = v;
        μ[n + 3] =   a; η[n + 3] =  -a; ξ[n + 3] =   b; w[n + 3] = v;
        μ[n + 4] =   a; η[n + 4] =  -a; ξ[n + 4] =  -b; w[n + 4] = v;
        μ[n + 5] =  -a; η[n + 5] =   a; ξ[n + 5] =   b; w[n + 5] = v;
        μ[n + 6] =  -a; η[n + 6] =   a; ξ[n + 6] =  -b; w[n + 6] = v;
        μ[n + 7] =  -a; η[n + 7] =  -a; ξ[n + 7] =   b; w[n + 7] = v;
        μ[n + 8] =  -a; η[n + 8] =  -a; ξ[n + 8] =  -b; w[n + 8] = v;
        μ[n + 9] =   a; η[n + 9] =   b; ξ[n + 9] =   a; w[n + 9] = v;
        μ[n + 10] =   a; η[n + 10] =  -b; ξ[n + 10] =   a; w[n + 10] = v;
        μ[n + 11] =   a; η[n + 11] =   b; ξ[n + 11] =  -a; w[n + 11] = v;
        μ[n + 12] =   a; η[n + 12] =  -b; ξ[n + 12] =  -a; w[n + 12] = v;
        μ[n + 13] =  -a; η[n + 13] =   b; ξ[n + 13] =   a; w[n + 13] = v;
        μ[n + 14] =  -a; η[n + 14] =  -b; ξ[n + 14] =   a; w[n + 14] = v;
        μ[n + 15] =  -a; η[n + 15] =   b; ξ[n + 15] =  -a; w[n + 15] = v;
        μ[n + 16] =  -a; η[n + 16] =  -b; ξ[n + 16] =  -a; w[n + 16] = v;
        μ[n + 17] =   b; η[n + 17] =   a; ξ[n + 17] =   a; w[n + 17] = v;
        μ[n + 18] =  -b; η[n + 18] =   a; ξ[n + 18] =   a; w[n + 18] = v;
        μ[n + 19] =   b; η[n + 19] =   a; ξ[n + 19] =  -a; w[n + 19] = v;
        μ[n + 20] =  -b; η[n + 20] =   a; ξ[n + 20] =  -a; w[n + 20] = v;
        μ[n + 21] =   b; η[n + 21] =  -a; ξ[n + 21] =   a; w[n + 21] = v;
        μ[n + 22] =  -b; η[n + 22] =  -a; ξ[n + 22] =   a; w[n + 22] = v;
        μ[n + 23] =   b; η[n + 23] =  -a; ξ[n + 23] =  -a; w[n + 23] = v;
        μ[n + 24] =  -b; η[n + 24] =  -a; ξ[n + 24] =  -a; w[n + 24] = v;
        n = 24
    elseif code == 5
        b = sqrt(1.0 - a^2)
        μ[n + 1] =   a; η[n + 1] =   b; ξ[n + 1] = 0.0; w[n + 1] = v;
        μ[n + 2] =   a; η[n + 2] =  -b; ξ[n + 2] = 0.0; w[n + 2] = v;
        μ[n + 3] =  -a; η[n + 3] =   b; ξ[n + 3] = 0.0; w[n + 3] = v;
        μ[n + 4] =  -a; η[n + 4] =  -b; ξ[n + 4] = 0.0; w[n + 4] = v;
        μ[n + 5] =   b; η[n + 5] =   a; ξ[n + 5] = 0.0; w[n + 5] = v;
        μ[n + 6] =   b; η[n + 6] =  -a; ξ[n + 6] = 0.0; w[n + 6] = v;
        μ[n + 7] =  -b; η[n + 7] =   a; ξ[n + 7] = 0.0; w[n + 7] = v;
        μ[n + 8] =  -b; η[n + 8] =  -a; ξ[n + 8] = 0.0; w[n + 8] = v;
        μ[n + 9] =   a; η[n + 9] = 0.0; ξ[n + 9] =   b; w[n + 9] = v;
        μ[n + 10] =   a; η[n + 10] = 0.0; ξ[n + 10] =  -b; w[n + 10] = v;
        μ[n + 11] =  -a; η[n + 11] = 0.0; ξ[n + 11] =   b; w[n + 11] = v;
        μ[n + 12] =  -a; η[n + 12] = 0.0; ξ[n + 12] =  -b; w[n + 12] = v;
        μ[n + 13] =   b; η[n + 13] = 0.0; ξ[n + 13] =   a; w[n + 13] = v;
        μ[n + 14] =   b; η[n + 14] = 0.0; ξ[n + 14] =  -a; w[n + 14] = v;
        μ[n + 15] =  -b; η[n + 15] = 0.0; ξ[n + 15] =   a; w[n + 15] = v;
        μ[n + 16] =  -b; η[n + 16] = 0.0; ξ[n + 16] =  -a; w[n + 16] = v;
        μ[n + 17] = 0.0; η[n + 17] =   a; ξ[n + 17] =   b; w[n + 17] = v;
        μ[n + 18] = 0.0; η[n + 18] =   a; ξ[n + 18] =  -b; w[n + 18] = v;
        μ[n + 19] = 0.0; η[n + 19] =  -a; ξ[n + 19] =   b; w[n + 19] = v;
        μ[n + 20] = 0.0; η[n + 20] =  -a; ξ[n + 20] =  -b; w[n + 20] = v;
        μ[n + 21] = 0.0; η[n + 21] =   b; ξ[n + 21] =   a; w[n + 21] = v;
        μ[n + 22] = 0.0; η[n + 22] =   b; ξ[n + 22] =  -a; w[n + 22] = v;
        μ[n + 23] = 0.0; η[n + 23] =  -b; ξ[n + 23] =   a; w[n + 23] = v;
        μ[n + 24] = 0.0; η[n + 24] =  -b; ξ[n + 24] =  -a; w[n + 24] = v;
        n = 24
    elseif code == 6
        c = sqrt(1.0 - a^2 - b^2)
        μ[n + 1] =   a; η[n + 1] =   b; ξ[n + 1] =   c; w[n + 1] = v;
        μ[n + 2] =   a; η[n + 2] =   b; ξ[n + 2] =  -c; w[n + 2] = v;
        μ[n + 3] =   a; η[n + 3] =  -b; ξ[n + 3] =   c; w[n + 3] = v;
        μ[n + 4] =   a; η[n + 4] =  -b; ξ[n + 4] =  -c; w[n + 4] = v;
        μ[n + 5] =  -a; η[n + 5] =   b; ξ[n + 5] =   c; w[n + 5] = v;
        μ[n + 6] =  -a; η[n + 6] =   b; ξ[n + 6] =  -c; w[n + 6] = v;
        μ[n + 7] =  -a; η[n + 7] =  -b; ξ[n + 7] =   c; w[n + 7] = v;
        μ[n + 8] =  -a; η[n + 8] =  -b; ξ[n + 8] =  -c; w[n + 8] = v;
        μ[n + 9] =   a; η[n + 9] =   c; ξ[n + 9] =   b; w[n + 9] = v;
        μ[n + 10] =   a; η[n + 10] =   c; ξ[n + 10] =  -b; w[n + 10] = v;
        μ[n + 11] =   a; η[n + 11] =  -c; ξ[n + 11] =   b; w[n + 11] = v;
        μ[n + 12] =   a; η[n + 12] =  -c; ξ[n + 12] =  -b; w[n + 12] = v;
        μ[n + 13] =  -a; η[n + 13] =   c; ξ[n + 13] =   b; w[n + 13] = v;
        μ[n + 14] =  -a; η[n + 14] =   c; ξ[n + 14] =  -b; w[n + 14] = v;
        μ[n + 15] =  -a; η[n + 15] =  -c; ξ[n + 15] =   b; w[n + 15] = v;
        μ[n + 16] =  -a; η[n + 16] =  -c; ξ[n + 16] =  -b; w[n + 16] = v;
        μ[n + 17] =   b; η[n + 17] =   a; ξ[n + 17] =   c; w[n + 17] = v;
        μ[n + 18] =   b; η[n + 18] =   a; ξ[n + 18] =  -c; w[n + 18] = v;
        μ[n + 19] =   b; η[n + 19] =  -a; ξ[n + 19] =   c; w[n + 19] = v;
        μ[n + 20] =   b; η[n + 20] =  -a; ξ[n + 20] =  -c; w[n + 20] = v;
        μ[n + 21] =  -b; η[n + 21] =   a; ξ[n + 21] =   c; w[n + 21] = v;
        μ[n + 22] =  -b; η[n + 22] =   a; ξ[n + 22] =  -c; w[n + 22] = v;
        μ[n + 23] =  -b; η[n + 23] =  -a; ξ[n + 23] =   c; w[n + 23] = v;
        μ[n + 24] =  -b; η[n + 24] =  -a; ξ[n + 24] =  -c; w[n + 24] = v;
        μ[n + 25] =   b; η[n + 25] =   c; ξ[n + 25] =   a; w[n + 25] = v;
        μ[n + 26] =   b; η[n + 26] =   c; ξ[n + 26] =  -a; w[n + 26] = v;
        μ[n + 27] =   b; η[n + 27] =  -c; ξ[n + 27] =   a; w[n + 27] = v;
        μ[n + 28] =   b; η[n + 28] =  -c; ξ[n + 28] =  -a; w[n + 28] = v;
        μ[n + 29] =  -b; η[n + 29] =   c; ξ[n + 29] =   a; w[n + 29] = v;
        μ[n + 30] =  -b; η[n + 30] =   c; ξ[n + 30] =  -a; w[n + 30] = v;
        μ[n + 31] =  -b; η[n + 31] =  -c; ξ[n + 31] =   a; w[n + 31] = v;
        μ[n + 32] =  -b; η[n + 32] =  -c; ξ[n + 32] =  -a; w[n + 32] = v;
        μ[n + 33] =   c; η[n + 33] =   a; ξ[n + 33] =   b; w[n + 33] = v;
        μ[n + 34] =   c; η[n + 34] =   a; ξ[n + 34] =  -b; w[n + 34] = v;
        μ[n + 35] =   c; η[n + 35] =  -a; ξ[n + 35] =   b; w[n + 35] = v;
        μ[n + 36] =   c; η[n + 36] =  -a; ξ[n + 36] =  -b; w[n + 36] = v;
        μ[n + 37] =  -c; η[n + 37] =   a; ξ[n + 37] =   b; w[n + 37] = v;
        μ[n + 38] =  -c; η[n + 38] =   a; ξ[n + 38] =  -b; w[n + 38] = v;
        μ[n + 39] =  -c; η[n + 39] =  -a; ξ[n + 39] =   b; w[n + 39] = v;
        μ[n + 40] =  -c; η[n + 40] =  -a; ξ[n + 40] =  -b; w[n + 40] = v;
        μ[n + 41] =   c; η[n + 41] =   b; ξ[n + 41] =   a; w[n + 41] = v;
        μ[n + 42] =   c; η[n + 42] =   b; ξ[n + 42] =  -a; w[n + 42] = v;
        μ[n + 43] =   c; η[n + 43] =  -b; ξ[n + 43] =   a; w[n + 43] = v;
        μ[n + 44] =   c; η[n + 44] =  -b; ξ[n + 44] =  -a; w[n + 44] = v;
        μ[n + 45] =  -c; η[n + 45] =   b; ξ[n + 45] =   a; w[n + 45] = v;
        μ[n + 46] =  -c; η[n + 46] =   b; ξ[n + 46] =  -a; w[n + 46] = v;
        μ[n + 47] =  -c; η[n + 47] =  -b; ξ[n + 47] =   a; w[n + 47] = v;
        μ[n + 48] =  -c; η[n + 48] =  -b; ξ[n + 48] =  -a; w[n + 48] = v;
        n = 48
    else
...
#=
    ld0006!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 6 point Lebedev angular grid.
=#
function ld0006!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0

    v  = 0.1666666666666667
    n += gen_oh!(1, a, b, v, n, μ, η, ξ, w)
...
#=
    ld0014!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 14 point Lebedev angular grid.
=#
function ld0014!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0026!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 26 point Lebedev angular grid.
=#
function ld0026!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0038!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 38 point Lebedev angular grid.
=#
function ld0038!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0050!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 50 point Lebedev angular grid.
=#
function ld0050!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0074!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 74 point Lebedev angular grid.
=#
function ld0074!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0086!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 86 point Lebedev angular grid.
=#
function ld0086!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0110!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 110 point Lebedev angular grid.
=#
function ld0110!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0146!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 146 point Lebedev angular grid.
=#
function ld0146!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0170!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 170 point Lebedev angular grid.
=#
function ld0170!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0194!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 194 point Lebedev angular grid.
=#
function ld0194!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0230!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 230 point Lebedev angular grid.
=#
function ld0230!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0266!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 266 point Lebedev angular grid.
=#
function ld0266!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0302!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 302 point Lebedev angular grid.
=#
function ld0302!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0350!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 350 point Lebedev angular grid.
=#
function ld0350!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0434!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 434 point Lebedev angular grid.
=#
function ld0434!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0590!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 590 point Lebedev angular grid.
=#
function ld0590!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0770!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 770 point Lebedev angular grid.
=#
function ld0770!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld0974!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 974 point Lebedev angular grid.
=#
function ld0974!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld1202!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 1202 point Lebedev angular grid.
=#
function ld1202!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld1454!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 1454 point Lebedev angular grid.
=#
function ld1454!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld1730!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 1730 point Lebedev angular grid.
=#
function ld1730!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld2030!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 2030 point Lebedev angular grid.
=#
function ld2030!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld2354!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 2354 point Lebedev angular grid.
=#
function ld2354!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld2702!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 2702 point Lebedev angular grid.
=#
function ld2702!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld3074!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 3074 point Lebedev angular grid.
=#
function ld3074!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld3470!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 3470 point Lebedev angular grid.
=#
function ld3470!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld3890!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 3890 point Lebedev angular grid.
=#
function ld3890!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld4334!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 4334 point Lebedev angular grid.
=#
function ld4334!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld4802!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 4802 point Lebedev angular grid.
=#
function ld4802!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
#=
    ld5294!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)

Compute the 5294 point Lebedev angular grid.
=#
function ld5294!(μ::AbstractVector, η::AbstractVector, ξ::AbstractVector, w::AbstractVector)
    a = 0.0
    b = 0.0
    n = 0
...
μ,η,ξ,w = LebedevByPoints(rules[N])
