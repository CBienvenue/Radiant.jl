...
"""
    set_particle(this::Method,particle::String)

To set the particle for which the transport discretization method is for. 

# Input Argument(s)
- `this::Method`: discretization method.
...
"""
    set_solver_type(this::Method,solver_type::String)
...
"""
    set_quadrature(this::Method,type::String,order::Int64)
...
"""
    set_legendre_order(this::Method,legendre_order::Int64)
...
"""
    set_angular_fokker_planck(this::Method,angular_fokker_planck::String)
...
"""
    set_angular_boltzmann(this::Method,angular_boltzmann::String)
...
"""
    set_convergence_criterion(this::Method,convergence_criterion::Float64)
...
"""
    set_maximum_iteration(this::Method,maximum_iteration::Int64)
...
"""
    set_scheme(this::Method,axis::String,scheme_type::String,scheme_order::Int64)
...
"""
    set_acceleration(this::Method,acceleration::String)
