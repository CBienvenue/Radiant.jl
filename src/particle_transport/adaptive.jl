...
- Alcouffe (1993) : An adaptive weighted diamond differencing method for three-dimensional
  xyz geometry.
- Voloschenko and Germogenova (1994) : Numerical solution of the time-dependant transport
  equation with pulsed sources.
- Germogenova et al. (1994) : Adaptive positive nodal method for transport equation.
